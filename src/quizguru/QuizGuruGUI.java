...
public class QuizGuruGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tournamentDropDown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "ACF Novice", "ACF Fall", "ACF Regionals", "ACF Nationals", "Penn Bowl", "NASAT", "MUT", "PACE", "Chicago Open", "HSAPQ", "NASAT", "Prison Bowl", "FICHTE", "Harvard", "VCU", "PADAWAN" }));
    ...
    public void Speak(String speech) {
        speech = speech.toLowerCase().replaceAll("'","").replaceAll("/", " ").replaceAll(" ii ", " 2 ").replaceAll("ftpe", "For ten points each:").replaceAll(" St.", " Saint ");
